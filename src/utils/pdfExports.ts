...
import { formatCurrency, SAUDI_RIYAL_SYMBOL } from './format';
...
const SAUDI_RIYAL_SYMBOL_ENTITY = SAUDI_RIYAL_SYMBOL;
...
export class PDFExportUtils {
  ...
  private generateInvoiceHTML(invoice: any, customer: any, lineItems: any[]): string {
    ...
    const currency = (invoice.currency || 'SAR').toUpperCase();
    const isSar = currency === 'SAR';
    const money = (amount: number) => isSar
      ? `${SAUDI_RIYAL_SYMBOL_ENTITY} ${formatCurrency(amount, 'SAR')}`
      ...
      <div style="padding: 20mm; font-family: Arial, sans-serif; font-size: 12px; line-height: 1.4; color: #000;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px; border-bottom: 2px solid #f97316; padding-bottom: 20px;">
          <div style="flex: 1;">
            ...
            <div style="font-size: 11px; color: #666;">
              ...
              <p style="margin: 0 0 4px 0;">VAT: 314076518400003</p>
            </div>
          </div>
            ...
            <div style="width: 300px;">
              <div style="background-color: #f9f9f9; padding: 16px; border-radius: 8px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                  ...
                  <span style="font-size: 11px; font-weight: bold;">${money(subtotal)}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                  <span style="font-size: 11px; color: #666;">VAT (15%):</span>
                  <span style="font-size: 11px; font-weight: bold;">${money(vatAmount)}</span>
                </div>
                <div style="border-top: 1px solid #ccc; padding-top: 8px;">
                  <div style="display: flex; justify-content: space-between;">
                    ...
                    <span style="font-size: 14px; font-weight: bold; color: #f97316;">${money(total)}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        ` : `
          <div style="margin-bottom: 30px; text-align: center; padding: 40px; background-color: #f9f9f9; border-radius: 8px;">
            <p style="font-size: 18px; font-weight: bold; color: #f97316; margin: 0 0 8px 0;">${money(invoice.amount)}</p>
