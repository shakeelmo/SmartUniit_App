              ...
              {activeTab === 'document' && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-dark-700 mb-2">Prepared By</label>
                      <input type="text" value={documentControl.preparedBy} onChange={(e) => setDocumentControl(prev => ({ ...prev, preparedBy: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-dark-700 mb-2">Reviewed By</label>
                      <input type="text" value={documentControl.reviewedBy || ''} onChange={(e) => setDocumentControl(prev => ({ ...prev, reviewedBy: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-dark-700 mb-2">Approved By</label>
                      <input type="text" value={documentControl.approvedBy || ''} onChange={(e) => setDocumentControl(prev => ({ ...prev, approvedBy: e.target.value }))} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                    </div>
